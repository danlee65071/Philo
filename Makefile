...
SRCS_BONUS = philo_bonus.c sem_init.c
PATH_SRCS_BONUS = $(addprefix $(DIR_SRCS)/, $(SRCS_BONUS))
...
PATH_HEADERS_BONUS = $(addprefix $(DIR_HEADERS)/, $(HEADERS_BONUS))
...
PATH_OBJS_BONUS = $(addprefix $(DIR_OBJS)/, $(OBJS_BONUS))
...
bonus: $(PATH_OBJS_BONUS)
	@echo "\n\
    		...
    		╚═╝░░░░░╚═╝░░╚═╝╚═╝╚══════╝░╚════╝░╚═════╝░░╚════╝░╚═╝░░░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚═════╝░"
	@echo "$(GREEN) objects were created $(RESET)"
	@$(CC) -lpthread $(FLAGS) -I $(DIR_HEADERS) $(PATH_OBJS_BONUS) -o $@
	@echo "$(GREEN) philo - [ok] $(RESET)"
	@echo "\n\
		   ░░░░░▄▄▄▄▀▀▀▀▀▀▀▀▄▄▄▄▄▄░░░░░░░\n\
		   ░░░░░█░░░░▒▒▒▒▒▒▒▒▒▒▒▒░░▀▀▄░░░░\n\
